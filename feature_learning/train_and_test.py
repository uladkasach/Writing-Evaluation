...
parser.add_argument("-e", "--embeddings_type", dest="embeddings_type", type=str, metavar='<str>', required=False, default="word2vec", help="Embeddings selection: custom, word2vec, or sense2vec.")
...
## retreive data
dataset, vocab = data_manager.get_data_for_fold(args.fold_base_path, args.bool_overwrite_pickle, args.embeddings_type);
